...
const buying = (mainSection2) =>{
    mainSection2.addEventListener('click',(e)=>{
        if (e.target.value == "buy"){
            ...
            if (e.target.parentElement === mainSection3.children[array.indexOf(e.target.parentElement)]){
                console.log(array.indexOf(e.target.parentElement));
            }else{
                ...
                array.push(e.target.parentElement);
                console.log(array);
                mainSection3.append(e.target.parentElement);
        ...
        mainSection3.append(total);
        comprar.className = "comprar";
        comprar.innerHTML = `<a href="#">Comprar</a>`
